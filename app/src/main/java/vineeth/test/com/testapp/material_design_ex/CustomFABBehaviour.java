...
public class CustomFABBehaviour extends FloatingActionButton.Behavior {

    public CustomFABBehaviour(Context context, AttributeSet set)
    {
        super();
    }
    ...
    public void onNestedScroll(CoordinatorLayout coordinatorLayout, FloatingActionButton child, View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int type)
    {
        super.onNestedScroll(coordinatorLayout, child, target, dxConsumed, dyConsumed, dxUnconsumed,
                dyUnconsumed,type);
        Log.d("FAB","Inside on nested scroll"+dyConsumed);
